.PHONY: help install build set-password agent-check agent-ping dev backend frontend seed seed-demo reset-db smoke accept accept-ui e2e fixture-site stop placeholders shots
