...
const INVALIDATES: Record<string, string[]> = {
  ...
  'lead.assigned': ['overview', 'leads', 'conversations', 'timeline', 'team', 'appointments'],
  'appointment.booked': ['overview', 'appointments', 'leads', 'conversations', 'timeline', 'team'],
  ...
  'handoff.triggered': ['overview', 'conversations', 'timeline', 'appointments'],
  'team.deactivated': ['team', 'overview', 'leads', 'conversations', 'appointments'],
  // Out status only affects the roster and assign pickers, not leads,
  // conversations or appointments the way deactivation does.
  'team.out_changed': ['team'],
